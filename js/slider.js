...
function init() {
  ...
  heroSlider.forEach(item => slider(item, {
    slidesPerView: 'auto',
    loop: true,
    effect: 'fade',
    fadeEffect: {
    ...
    navigation: {
      nextEl: '.swipe-hero-next',
      prevEl: '.swipe-hero-prev'
    }
  }));
  const causesSlider = document.querySelectorAll('[data-slider="causes-slider"]');
  causesSlider.forEach(item => slider(item, {
    slidesPerView: 'auto',
    rewind: true,
    effect: 'fade',
    fadeEffect: {
    ...
    navigation: {
      nextEl: '.swipe-causes-next',
      prevEl: '.swipe-causes-prev'
    }
  }));
  const servicesSlider = document.querySelectorAll('[data-slider="services-slider"]');
  servicesSlider.forEach(item => slider(item, {
    slidesPerView: 'auto',
    rewind: true,
    navigation: {
      nextEl: '.swipe-services-next',
      prevEl: '.swipe-services-prev'
    }
  }));
  const equipmentSlider = document.querySelectorAll('[data-slider="equipment-slider"]');
  equipmentSlider.forEach(item => slider(item, {
    slidesPerView: 'auto',
    rewind: true,
    effect: 'fade',
    fadeEffect: {
    ...
    navigation: {
      nextEl: '.swipe-equipment-next',
      prevEl: '.swipe-equipment-prev'
    }
  }));
  const doctorsSlider = document.querySelectorAll('[data-slider="doctors-slider"]');
  doctorsSlider.forEach(item => slider(item, {
    slidesPerView: 'auto',
    rewind: true,
    navigation: {
      nextEl: '.swipe-doctors-next',
      prevEl: '.swipe-doctors-prev'
    }
  }));
}
(function () {
